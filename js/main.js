...
let productsOne = [
    { id: 1, name: "  جبس أبيض كناوف 3 م", unit: "لوح", price: 270},
    { id: 2, name: "  جبس أبيض كناوف 2.8 م", unit: "لوح", price: 250},
    
    { id: 3, name: "  جبس أخضر كناوف ", unit: "لوح", price: 370},
    { id: 4, name: "جبس أحمر كناوف", unit: "لوح", price: 325},
    
    { id: 5, name: "جبس أبيض جي بورد", unit: "لوح", price: 235},
    { id: 6, name: "جبس أخضر جي بورد", unit: "لوح", price: 320}
];

let productsTwo = [
    { id: 7, name: " زاوية 3", unit: "عود", price: 20},
    { id: 8, name: " أوميجا 3", unit: "عود", price: 40},
    { id: 9, name: " سي 3", unit: "عود", price: 30},
    
    { id: 10, name: " زاوية 35", unit: "عود", price: 23},
    { id: 11, name: " أوميجا 35", unit: "عود", price: 46},
    { id: 12, name: " سي 35", unit: "عود", price: 35},
    
    { id: 13, name: " زاوية 4", unit: "عود", price: 26},
    { id: 14, name: " أوميجا 4", unit: "عود", price: 52},
    { id: 15, name: " سي 4", unit: "عود", price: 39},
    
    { id: 16, name: " خشن 5 سم", unit: "عود", price: 80},
    { id: 17, name: "  ناعم 5 سم", unit: "عود", price: 75},
    
    { id: 18, name: "  خشن 7 سم", unit: "عود", price: 85},
    { id: 19, name: "  ناعم 7 سم", unit: "عود", price: 80}
]
let productsThree = [
    ...
    { id: 30, name: " أكمن", unit: "علبة", price: 130},
    { id: 31, name: " فيشر", unit: "علبة", price: 5},
    { id: 32, name: " تيش مصري", unit: "عود", price: 30},
    { id: 33, name: " تيش مستورد", unit: "عود", price: 35},
    { id: 34, name: " كورنر بيد", unit: "عود", price: 40},
    { id: 35, name: " آند بيد", unit: "عود", price: 40},
    ...
    { id: 41, name: " كورنير", unit: "زاوية", price: 25},
