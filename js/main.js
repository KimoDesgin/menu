...
let productsTwo = [
    { id: 7, name: " زاوية 3", unit: "عود", price: 25},
    { id: 8, name: " أوميجا 3", unit: "عود", price: 50},
    { id: 9, name: " سي 3", unit: "عود", price: 37.5},
    { id: 10, name: " زاوية 35", unit: "عود", price: 28},
    { id: 11, name: " أوميجا 35", unit: "عود", price: 56},
    { id: 12, name: " سي 35", unit: "عود", price: 42},
    { id: 13, name: " زاوية 4", unit: "عود", price: 31},
    { id: 14, name: " أوميجا 4", unit: "عود", price: 62},
    { id: 15, name: " سي 4", unit: "عود", price: 46.5},
    { id: 16, name: " خشن 5 سم", unit: "عود", price: 95},
    { id: 17, name: "  ناعم 5 سم", unit: "عود", price: 90},
    { id: 18, name: "  خشن 7 سم", unit: "عود", price: 110},
    { id: 19, name: "  ناعم 7 سم", unit: "عود", price: 105}
]
let productsThree = [
    { id: 20, name: " ميتال", unit: "بكرة", price: 130},
    ...
    { id: 31, name: " فيشر", unit: "علبة", price: 6},
    { id: 32, name: " تيش مصري", unit: "عود", price: 35},
    { id: 33, name: " تيش مستورد", unit: "عود", price: 40},
    { id: 34, name: " كورنر بيد", unit: "عود", price: 40},
    { id: 35, name: " آند بيد", unit: "عود", price: 40},
    { id: 36, name: "  شادو جاب", unit: "عود", price: 125},
    { id: 37, name: " عصفورة U", unit: "عدد", price: 1.5},
    { id: 38, name: " عصفورة L", unit: "عدد", price: 3},
